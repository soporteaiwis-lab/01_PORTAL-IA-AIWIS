...
import { User, UserRole, TrainingModule, TrainingVideo } from '../types';
...
export const ClassesView = ({ currentUser }: { currentUser: User }) => {
          ...
          <div className="relative z-10">
              {isEditingTitle ? (
                  ...
                  <div>
                      ...
                      <p className="text-sm text-slate-400 mt-1">Portal de Aprendizaje</p>
                  </div>
              )}
          </div>
